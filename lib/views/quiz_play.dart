...
import 'package:survey_app/services/database.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:survey_app/widget/widget.dart';
import 'package:survey_app/widgets/quiz_play_widgets.dart';
          ...
          : SingleChildScrollView(
              child: Container(
                child: Column(
                  children: [
                    InfoHeader(
                      length: questionSnaphot!.docChanges.length,
                    ),
                    SizedBox(
                      height: 10,
                    ),
